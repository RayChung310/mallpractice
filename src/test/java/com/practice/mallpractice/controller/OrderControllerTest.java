...
class OrderControllerTest {
    ...
    public void createOrder_success() throws Exception {
        CreateOrderRequset createOrderRequset = new CreateOrderRequset();
        ...
        createOrderRequset.setBuyItemList(buyItemList);

        String json = objectMapper.writeValueAsString(createOrderRequset);
    ...
    public void createOrder_illegalArgument_emptyBuyItemList() throws Exception {
        CreateOrderRequset createOrderRequest = new CreateOrderRequset();
        List<BuyItem> buyItemList = new ArrayList<>();
